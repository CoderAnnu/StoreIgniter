                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-3 p-md-4 w-100 fmxw-500">
                        ...
                        <div class="text-center text-md-center mb-3 mt-md-0" ng-if="completed">
                            ...
                            <p class="mb-4">Password Reset Email has been sent to your register email address.</p>
                        </div>
                        <form ng-submit="ForgotPassword(user)" ng-if="!completed" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" ng-model="user.email" class="form-control" id="ForgotPasswordEmail" aria-describedby="ForgotPasswordEmail" placeholder="Email" required>
                                </div>
                            </div>
                            <!-- End of Form -->
                            <div class="d-grid">
                                <button type="submit" ng-disabled="loading || !user.email" class="btn btn-gray-800">Recover Password</button>
                            </div>
                        </form>
                        ...
                        <div class="d-flex justify-content-center align-items-center pt-2">
                            <span class="fw-normal">
                                If Remember!
                                <a href="#!/signin" class="fw-bold">Login here</a>
                            </span>
                        </div>
                    </div>
                </div>
