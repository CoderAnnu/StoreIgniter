<!-- Load Footer -->
<?= view('frontend/Components/header'); ?>

<!-- Sections:Start -->
<div data-bs-spy="scroll" class="scrollspy-example">
  <!-- Hero: Start -->
  <section id="landingHero" class="section-py landing-hero" style="background-image: url('assets/LandingPage/assets/img/backgrounds/hero-bg.png');">
    <div class="container">
      ...
      <div class="position-relative hero-animation-img">
        <a href="../vertical-menu-template/dashboards-crm.html" target="_blank">
          <div class="hero-dashboard-img text-center">
            <img src="<?= base_url('assets/LandingPage/assets/img/backgrounds/hero-dashboard-light.png'); ?>" alt="hero dashboard" class="img-fluid animation-img" style="transform: translate(6.22px, 1.12px);">
          </div>
        </a>
      </div>
    </div>
  ...
  <section id="landingFeatures" class="section-py landing-features">
    <div class="container">
      <h6 class="text-center fw-semibold d-flex justify-content-center align-items-center mb-4">
        <img src="<?= base_url('assets/LandingPage/assets/img/elements/section-tilte-icon.png'); ?>" alt="section title icon" class="me-2">
      ...
      <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-3">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/laptop-charging.png'); ?>" alt="laptop charging">
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-3">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/transition-up.png'); ?>" alt="transition up">
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-3">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/edit.png'); ?>" alt="edit">
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-3">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/3d-select-solid.png'); ?>" alt="3d select solid">
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-3">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/lifebelt.png'); ?>" alt="lifebelt">
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-3">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/google-docs.png'); ?>" alt="google docs">
          </div>
        ...
        <div class="swiper-wrapper" id="swiper-wrapper-2df731d723be2d74" aria-live="off" style="cursor: grab; transition-duration: 0ms; transform: translate3d(-4404.5px, 0px, 0px);">
          <div class="swiper-slide" role="group" aria-label="4 / 15" style="width: 363px; margin-right: 20px;" data-swiper-slide-index="3">
            <div class="card h-100">
              <div class="card-body text-body d-flex flex-column justify-content-between text-center">
                <div class="mb-3">
                  <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-2.png'); ?>" alt="client logo" class="client-logo img-fluid">
                </div>
                <p>
          ...
          <div class="swiper-slide" role="group" aria-label="5 / 15" style="width: 363px; margin-right: 20px;" data-swiper-slide-index="4">
            <div class="card h-100">
              <div class="card-body text-body d-flex flex-column justify-content-between text-center">
                <div class="mb-3">
                  <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-5.png'); ?>" alt="client logo" class="client-logo img-fluid">
                </div>
                <p>
          ...
          <div class="swiper-slide" role="group" aria-label="6 / 15" style="width: 363px; margin-right: 20px;" data-swiper-slide-index="5">
            <div class="card h-100">
              <div class="card-body text-body d-flex flex-column justify-content-between text-center h-100">
                <div class="mb-3">
                  <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-4.png'); ?>" alt="client logo" class="client-logo img-fluid">
                </div>
                <p>
                  “I've never used a theme as versatile and flexible as Vuexy. It's my go to for building dashboard
                  sites on almost any project.”
          ...
          <div class="swiper-slide" role="group" aria-label="8 / 15" style="width: 363px; margin-right: 20px;" data-swiper-slide-index="7">
            <div class="card h-100">
              <div class="card-body text-body d-flex flex-column justify-content-between text-center h-100">
                <div class="mb-3">
                  <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-3.png'); ?>" alt="client logo" class="client-logo img-fluid">
                </div>
                <p>
        ...
        <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden" id="swiper-clients-logos">
          <div class="swiper-wrapper" id="swiper-wrapper-ba5fff481533bbf10" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-458.667px, 0px, 0px);">
            <div class="swiper-slide" role="group" aria-label="1 / 5" style="width: 229.333px;">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-1-light.png'); ?>" alt="client logo" class="client-logo" data-app-light-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-1-light.png'); ?>" data-app-dark-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-1-dark.png'); ?>">
            </div>
            <div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 5" style="width: 229.333px;">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-2-light.png'); ?>" alt="client logo" class="client-logo" data-app-light-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-2-light.png'); ?>" data-app-dark-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-2-dark.png'); ?>">
            </div>
            <div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 5" style="width: 229.333px;">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-3-light.png'); ?>" alt="client logo" class="client-logo" data-app-light-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-3-light.png'); ?>" data-app-dark-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-3-dark.png'); ?>">
            </div>
            <div class="swiper-slide swiper-slide-next" role="group" aria-label="4 / 5" style="width: 229.333px;">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-4-light.png'); ?>" alt="client logo" class="client-logo" data-app-light-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-4-light.png'); ?>" data-app-dark-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-4-dark.png'); ?>">
            </div>
            <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 229.333px;">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/logo-5-light.png'); ?>" alt="client logo" class="client-logo" data-app-light-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-5-light.png'); ?>" data-app-dark-img="<?= base_url('assets/LandingPage/assets/img/elements/logo-5-dark.png'); ?>">
            </div>
          </div>
          <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
        </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card card-hover-border-primary mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-primary position-relative team-image-box">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/team-member-1.png'); ?>" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card card-hover-border-danger mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-danger position-relative team-image-box">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/team-member-2.png'); ?>" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
            </div>
            <div class="card-body text-center">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card card-hover-border-success mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-success position-relative team-image-box">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/team-member-3.png'); ?>" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
            </div>
            <div class="card-body text-center">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="card card-hover-border-info mt-3 mt-lg-0 shadow-none">
            <div class="bg-label-info position-relative team-image-box">
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/team-member-4.png'); ?>" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image">
            </div>
            <div class="card-body text-center">
        ...
        <div class="col-xl-4 col-lg-6">
          <div class="card shadow-none">
            <div class="card-header border-0">
              ...
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/smiling-icon.png'); ?>" alt="smiling icon">
            </div>
            <div class="card-body">
              <ul class="list-unstyled">
                <li>
                  <h5>
                    <img src="<?= base_url('assets/LandingPage/assets/img/elements/list-arrow-icon.png'); ?>" alt="list arrow icon" class="me-2 pe-1 scaleX-n1-rtl">
                    Timeline
                  </h5>
                </li>
                <li>
      ...
      <div class="row gy-5">
        <div class="col-lg-5">
          <div class="text-center">
            <img src="<?= base_url('assets/LandingPage/assets/img/elements/sitting-girl-with-laptop.png'); ?>" alt="sitting girl with laptop" class="faq-image">
          </div>
        </div>
        <div class="col-lg-7">
    ...
    <div class="container">
      <div class="row align-items-center gy-5 gy-lg-0">
        ...
        <div class="col-lg-6 pt-lg-5">
          <img src="<?= base_url('assets/LandingPage/assets/img/backgrounds/cta-dashboard.png'); ?>" alt="cta dashboard" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-5">
          <div class="card h-100">
            <div class="bg-primary rounded text-white card-body">
              ...
              <img src="<?= base_url('assets/LandingPage/assets/img/elements/contact.png') ?>" alt="let’s contact" class="w-100 mb-2 pb-1">
              <p class="mb-0">
