...
<body>
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        <!-- Hero: Start -->
        <section id="landingHero" class="section-py landing-hero" style="background-image: url('Project-Template/Materio/LandingPage/assets/img/backgrounds/hero-bg.png');">
            <div class="container">
